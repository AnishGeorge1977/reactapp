    ...
    render(){
        return(
            <div>
                ...
                <button className={"btn btn-primary margin-auto"}
                        onClick={()=>this.callingHomePage()}>Brief</button>
                <button className={"btn btn-warning margin-auto"}
                        onClick={()=>this.callingCertPage()}>Certificates</button>
                <button className={"btn btn-secondary margin-auto"}
                        onClick={()=>this.callingResumePage()}>Resume</button>  
                <button className={"btn btn-dark margin-auto"}
                        onClick={()=>this.callingWorkPage()}>Experience</button>  
                <button className={"btn btn-danger margin-auto"}
